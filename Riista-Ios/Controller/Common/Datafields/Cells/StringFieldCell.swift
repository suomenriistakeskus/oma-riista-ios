...
fileprivate let CELL_TYPE = DataFieldCellType.string

class StringFieldCell<FieldId : DataFieldId>: TextFieldCell<FieldId, StringField<FieldId>> {
    ...
    class Factory<FieldId : DataFieldId>: DataFieldCellFactory<FieldId> {
        ...
        override func registerCellType(to tableView: UITableView) {
            tableView.register(StringFieldCell<FieldId>.self, forCellReuseIdentifier: CELL_TYPE.reuseIdentifier)
        }
