...
class ModifyGroupHuntingObservationViewController<Controller: ModifyGroupObservationController>:
    BaseControllerWithViewModel<ModifyGroupObservationViewModel, Controller>,
    ...
    public override func viewDidLoad() {
        ...
        tableViewController.addDefaultCellFactories(
            ...
            huntingDayEventDispacter: controller.huntingDayEventDispatcher,
