...
/**
 Migrates the ObservationEntry entities from model V12 to V13. This migration consists of migrating
 ...
 This class is closely related to MigrationFromV12ToV13.xcmappingmodel
 */
internal class ObservationEntryMappingV12ToV13: NSEntityMigrationPolicy {
    ...
    public static func determineCategoryFor(withinMooseHunting: NSNumber?) -> NSString {
        // treat withinMooseHunting as NSNumber even though it is stored as Boolean in core data.
        // -> this makes it easier to check nils
        let category = withinMooseHunting != nil && withinMooseHunting!.intValue > 0 ? "MOOSE_HUNTING" : "NORMAL"
        print("migration: observationCategory " + category + " for when withinMooseHunting = " +
            (withinMooseHunting != nil ? String(withinMooseHunting!.intValue) : "<nil>"))
        return category as NSString
    }
}
